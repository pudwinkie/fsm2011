...
namespace fsm {
		static class Language {
				public static string[] lang = Language.Polish;
...
//AutomatCreator//
					...
					"Start", //1
					"Letter: ", //2
					"You have to write a letter", //3
					"Warning", //4
					"State name", //5
					"You have to write state name", //6
					"Choose letters to remove:", //7
					"Remove letters", //8
					"Choose states names to remove:", //9
					"Remove states", //10
					"Change letter", //11
					"Choose letter", //12
					"This letter is undefined ", //13
					"Change state name", //14
					"Choose state", //15
					"There is no accepting state", //16
					"Accepting", //17
					"Add Letter", //18
					"Add State", //19
					"Remove State", //20
...
//Dialog//
				  "accept word: ", //30
					"don't accept word: ", //31
					"Raport", //32
					"Enter name", //33
//LanguageDialog//
				  "Language", //34
					"Remove", //35
					"Do you want to save machine?", //36
					"No", //37
					"Yes", //38
					"Machine name", //39
					"Machine info", //40
