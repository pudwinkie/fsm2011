    ...
    partial class AutomatCreator
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.StateNameColumn});
						this.fPTable.EditMode = System.Windows.Forms.DataGridViewEditMode.EditOnF2;
						...
						// Accepting
						// 
						this.Accepting.HeaderText = "Akceptujacy";
						this.Accepting.Name = "Accepting";
						this.Accepting.Width = 60;
						// 
						// StateNameColumn
						// 
						this.StateNameColumn.HeaderText = "Nazwa stanu";
						...
						this.AddLetterButton.Text = "Dodaj literę";
						...
						this.AddStateButton.Text = "Dodaj stan";
						...
						this.RemoveStateButton.Text = "Usun stan";
						...
						this.RemoveLetterButton.Text = "Usun literę";
						...
						this.changeLetterButton.Text = "Zmień literę";
						...
						this.ChangeStateNameButton.Text = "Zmień nazwę stanu";
						...
						this.infoButton.Location = new System.Drawing.Point(322, 312);
